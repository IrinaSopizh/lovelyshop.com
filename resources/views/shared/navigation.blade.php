				...
				<div class="row">
					...
					<div class="col-lg-6 col-md-6 col-sm-7">
						<div class="header-top-left">
							<div class="top-message">Шкіряні вироби українських майстрів</div>
							<div class="phone-number"> Зателефонуйте нам: <span>(063) 645-31-50</span></div>
						</div>
					</div>
					<!-- header-top-left end -->
					...
					<div class="col-lg-6 col-md-6 col-sm-5">
						<div class="header-top-right">
							...
							<div class="top-menu">
								<ul>
									<li><a href="my-account.html">Особистий кабінет</a></li>
				...
				<div class="row">
					...
					<div class="col-lg-6 col-md-6 col-sm-8 col-xs-12">
						...
						<div class="cart-total">
							<ul>
								<li><a href="cart.html"><span class="cart-icon"><i class="fa fa-shopping-cart"></i></span> <span class="cart-no">Корзина: (2)</span></a>
								...
								<ul>
									...
									<li><a href="shop.html">Каталог</a>
										<div class="mega-menu">											
											...
											<span>
												<a href="#" class="mega-title">Для чоловіків </a>
												<a href="shop.html">casual shirt</a>
												<a href="shop.html">rikke t-shirt</a>
												<a href="shop.html">mia top </a>
												<a href="shop.html">muscle tee </a>
											...
											<span>
												<a href="#" class="mega-title">Різне </a>
